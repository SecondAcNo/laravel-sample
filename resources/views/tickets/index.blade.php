<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="GET" action="{{ route('tickets.index') }}" class="mb-6 bg-white p-4 shadow-sm sm:rounded-lg">
                ...
                <div class="mt-4 flex items-center gap-3">
                    ...
                    <a href="{{ route('tickets.index') }}" class="text-sm text-gray-600 hover:text-gray-900">クリア</a>
                </div>
            </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">カテゴリ</th>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @forelse ($tickets as $ticket)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{{ $ticket->category->name }}</td>
